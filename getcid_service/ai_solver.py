    ...
    for idx, api_key in enumerate(api_keys):
        try:
            ...
            prompt = (
                ...
                "1. Encuentra dónde está el icono objetivo en las vías de la imagen derecha. "
                "2. Encuentra dónde está el tren actualmente. "
                "3. Las vías son un circuito CÍCLICO con dirección. Sigue la línea roja punteada hacia adelante desde el tren. "
                "4. Cuenta cuántas 'paradas' (iconos) hay desde el tren hasta el objetivo. "
                "5. ¡MUY IMPORTANTE! Si el tren está en el ÚLTIMO icono de la vía (al final), avanzar un paso (1 clic) lo teletransporta de regreso al PRIMER icono del inicio de la vía. "
                "Ejemplo: Si el camino es A -> B -> C -> D, y el tren está en D, 1 clic lo lleva a A. 2 clics lo llevan a B. "
                "NUNCA calcules la distancia 'más corta' en línea recta. SIEMPRE sigue el camino de las vías, y si se acaba, empieza desde el inicio. "
